...
# print(f"\n\n{sys.argv}\n\n")
test_img_paths[0] = sys.argv[1]
# test_img_paths[0] = ".\\2.jpeg"
# print(f"\n\nDBG-I:{test_img_paths}\n\n")
# print(f"\n\nDBG-II:{test_labels_cleaned}\n\n")
...
prediction_model = pickle.load(open(model_pkl_file, 'rb'))
